...
export class Migration20220214094038 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table `token` (`id` integer not null primary key autoincrement, `created_at` datetime not null, `updated_at` datetime not null, `bech32` text not null, `base16` text not null, `decimals` json not null default 1, `init_supply` bigserial not null, `name` text not null, `symbol` text not null, `contract_owner` text not null, `base_uri` text not null, `type` integer not null);');
